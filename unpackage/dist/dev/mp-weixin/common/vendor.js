...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"洗衣液小程序","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var _user = _interopRequireDefault(__webpack_require__(/*! ./modules/user */ 49));
var _cart = _interopRequireDefault(__webpack_require__(/*! ./modules/cart */ 50));
var _starCard = _interopRequireDefault(__webpack_require__(/*! ./modules/star-card */ 51));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    UPDATE_CONFIG: function UPDATE_CONFIG(state, config) {
      state.config = _objectSpread(_objectSpread({}, state.config), config);
    }
  },
  actions: {
    // 显示loading
    ...
    // 隐藏loading
    hideLoading: function hideLoading(_ref2) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                ...
                console.error('获取配置失败:', _context.t0);
                return _context.abrupt("return", null);
              case 15:
              case "end":
...
var _default = store;
exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/uni-cloud/dist/index.js */ 39)["uniCloud"]))
...
var N = "";
try {
  N = (__webpack_require__(/*! uni-stat-config */ 47).default || __webpack_require__(/*! uni-stat-config */ 47)).appid;
} catch (e) {}
var R,
  L = {};
function U(e) {
...
/* 46 */
/*!************************************************************!*\
  !*** D:/私活/xiyiye/pages.json?{"type":"origin-pages-json"} ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  "pages": [{
    ...
    "style": {
      "navigationBarTitleText": "海星分享卡"
    }
  }, {
    "path": "pages/trial/trial",
    "style": {
      "navigationBarTitleText": "免费试用"
    }
  }, {
    "path": "pages/stored-value/stored-value",
    "style": {
  ...
  "tabBar": {
    ...
    "list": [{
      ...
      "text": "商城",
      "iconPath": "static/tabbar/avatar.png",
      "selectedIconPath": "static/tabbar/avatar.png"
    }, {
      "pagePath": "pages/star-card/star-card",
      "text": "海星卡",
      "iconPath": "static/tabbar/avatar.png",
      "selectedIconPath": "static/tabbar/avatar.png"
    }, {
  ...
  "easycom": {
    "autoscan": true,
    "custom": {
      "^t-(.*)": "tdesign-uniapp/lib/components/$1/index"
    }
  }
};
exports.default = _default;
...
/* 47 */
/*!***********************************************!*\
  !*** D:/私活/xiyiye/pages.json?{"type":"stat"} ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 49 */
/*!******************************************!*\
  !*** D:/私活/xiyiye/store/modules/user.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var actions = {
  ...
  wxLogin: function wxLogin(_ref) {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
      var commit, dispatch, loginRes, res, _res$result$data, token, userInfo;
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
            ...
            case 9:
              ...
              _res$result$data = res.result.data, token = _res$result$data.token, userInfo = _res$result$data.userInfo; // 3. 保存认证信息
  ...
  // 更新用户信息
  updateUserInfo: function updateUserInfo(_ref3, userInfo) {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
      var commit, res, updatedUserInfo;
      return _regenerator.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
            ...
            case 4:
              ...
              updatedUserInfo = res.result.data;
            ...
            case 15:
              ...
              console.error('更新用户信息失败:', _context3.t0);
              return _context3.abrupt("return", {
                success: false,
...
/* 50 */
/*!******************************************!*\
  !*** D:/私活/xiyiye/store/modules/cart.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var mutations = {
  SET_CART_ITEMS: function SET_CART_ITEMS(state, items) {
    state.items = items;
    // 计算总价和总数
    state.totalCount = items.reduce(function (sum, item) {
      return sum + item.quantity;
    }, 0);
    state.totalAmount = items.reduce(function (sum, item) {
  ...
  ADD_TO_CART: function ADD_TO_CART(state, product) {
    ...
    if (existingItem) {
      ...
      state.items.push(_objectSpread(_objectSpread({}, product), {}, {
    ...
    // 重新计算总价和总数
    state.totalCount = state.items.reduce(function (sum, item) {
      return sum + item.quantity;
    }, 0);
    state.totalAmount = state.items.reduce(function (sum, item) {
      return sum + item.price * item.quantity;
    }, 0);
  ...
  UPDATE_CART_ITEM: function UPDATE_CART_ITEM(state, _ref) {
    var id = _ref.id,
...
var actions = {
  // 从本地存储加载购物车
  loadCartFromStorage: function loadCartFromStorage(_ref2) {
    var commit = _ref2.commit;
    var cartItems = uni.getStorageSync('cartItems') || [];
  ...
  // 更新购物车商品数量
  updateCartItem: function updateCartItem(_ref4, payload) {
    var commit = _ref4.commit;
    commit('UPDATE_CART_ITEM', payload);
  },
  // 删除购物车商品
  removeFromCart: function removeFromCart(_ref5, id) {
...
/* 51 */
/*!***********************************************!*\
  !*** D:/私活/xiyiye/store/modules/star-card.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var mutations = {
  SET_STAR_CARDS: function SET_STAR_CARDS(state, cards) {
    state.myStarCards = cards;
  },
  SET_SHARED_CARDS: function SET_SHARED_CARDS(state, cards) {
    state.sharedCards = cards;
  },
  SET_RECEIVED_CARDS: function SET_RECEIVED_CARDS(state, cards) {
    state.receivedCards = cards;
  },
  SET_STAR_STATS: function SET_STAR_STATS(state, stats) {
    state.starCardStats = stats;
  },
  ADD_STAR_CARD: function ADD_STAR_CARD(state, card) {
    state.myStarCards.unshift(card);
  },
  UPDATE_STAR_CARD: function UPDATE_STAR_CARD(state, _ref) {
    var id = _ref.id,
      updates = _ref.updates;
    var card = state.myStarCards.find(function (c) {
      return c.id === id;
    });
    if (card) {
...
var actions = {
  // 创建海星分享卡
  createStarCard: function createStarCard(_ref2, cardData) {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
      var commit, rootGetters, res, card;
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
            ...
            case 15:
              _context.prev = 15;
              _context.t0 = _context["catch"](1);
              console.error('创建海星卡失败:', _context.t0);
              uni.showToast({
  ...
  // 获取我的海星卡列表
  getMyStarCards: function getMyStarCards(_ref3) {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
      var commit, res;
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 11:
              _context2.prev = 11;
              _context2.t0 = _context2["catch"](1);
              console.error('获取海星卡列表失败:', _context2.t0);
              return _context2.abrupt("return", []);
            case 15:
            case "end":
              return _context2.stop();
  ...
  // 获取海星卡统计
  getStarCardStats: function getStarCardStats(_ref4) {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
      var commit, res;
      return _regenerator.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 11:
              _context3.prev = 11;
              _context3.t0 = _context3["catch"](1);
              console.error('获取海星卡统计失败:', _context3.t0);
              return _context3.abrupt("return", null);
            case 15:
            case "end":
              return _context3.stop();
  ...
  // 分享海星卡
  shareStarCard: function shareStarCard(_ref5, cardId) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 13:
              ...
              console.error('分享海星卡失败:', _context4.t0);
              uni.showToast({
                title: _context4.t0.message || '分享失败',
                icon: 'none'
              });
              return _context4.abrupt("return", {
                success: false,
  ...
  // 接收海星卡
  receiveStarCard: function receiveStarCard(_ref6, _ref7) {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5() {
      var commit, cardId, shareCode, res;
      return _regenerator.default.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              commit = _ref6.commit;
              cardId = _ref7.cardId, shareCode = _ref7.shareCode;
              _context5.prev = 2;
              _context5.next = 5;
              return uniCloud.callFunction({
                name: 'starCard',
            ...
            case 14:
              ...
              console.error('接收海星卡失败:', _context5.t0);
              uni.showToast({
                title: _context5.t0.message || '接收失败',
                icon: 'none'
              });
              return _context5.abrupt("return", {
                success: false,
...
var getters = {
  myStarCards: function myStarCards(state) {
    return state.myStarCards;
  },
  sharedCards: function sharedCards(state) {
    return state.sharedCards;
  },
  receivedCards: function receivedCards(state) {
    return state.receivedCards;
  },
  starCardStats: function starCardStats(state) {
    return state.starCardStats;
  },
  activeStarCards: function activeStarCards(state) {
    return state.myStarCards.filter(function (card) {
      return card.status === 'active';
    });
  },
  totalReward: function totalReward(state) {
    return state.starCardStats.totalReward;
  }
};
var _default = {
  namespaced: true,
...
exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/uni-cloud/dist/index.js */ 39)["uniCloud"], __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 2)["default"]))

/***/ }),
/* 52 */
/*!*****************************!*\
  !*** D:/私活/xiyiye/uni.scss ***!
  \*****************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.shareToWechat = shareToWechat;
...
function isEmpty(value) {
  ...
  if ((0, _typeof2.default)(value) === 'object') return Object.keys(value).length === 0;
  return false;
}
